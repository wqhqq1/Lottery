...
class LockView : UIView {
    ...
    init(frame: CGRect, isComplete: Binding<Bool>, correct: Binding<Bool>, loadSheet: Binding<Bool>, showSheet: Binding<Bool>) {
    ...
    private func updateShacklePath() {
        if progress <= 1.0 {
            ...
            let shackleLiftKeytime: CGFloat = 0.3
